...
foreach (['admin-system.php', 'admin.php', 'admin-legal.php', 'admin-support.php', 'admin-kunde.php'] as $f) {
...
foreach ([['admin-system.php', 'test_mail'], ['admin-system.php', 'test_prenotification'], ['admin-system.php', 'publish_now'], ['admin-system.php', 'sync_enqueue'], ['admin-system.php', 'org_sync_resume'],
          ...
          ['admin-kunde.php', 'org_update'], ['admin-kunde.php', 'user_update']] as [$f, $a]) {
    $fs = $forms($src($f), $a);
