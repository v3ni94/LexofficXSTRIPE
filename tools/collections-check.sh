...
echo "16) Stripe-Verbindungszustand: SEPA-Faehigkeit, Berechtigung, Modus (4.79)"
...
P16=$(pis)
OUT="$($SIM stripe_state $A)"; erw "Verbindung aus der Zeit vor 4.79 (Faehigkeit unbekannt): unverified, Einzuege weiter moeglich" state unverified; erw "bereit" ready 1
