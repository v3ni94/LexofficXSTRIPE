...
Stand 13.09.2026, Code 4.76 (Arbeitsbranch). Primärquellen von Stripe waren in dieser Sitzung nicht abrufbar (Netzsperre);
...
## 3. Verbindungszustände (seit 4.76)
...
- Signatur über den unveränderten Body mit dem Secret der Firma (`stripe_verify_webhook_signature`), Beanspruchung je
  ...
  Verarbeitungsfehlern, 200 bei bewusstem Ignorieren. Seit 4.76 wird `livemode` gegen `stripe_mode` der Firma geprüft.
