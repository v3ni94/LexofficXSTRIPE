...
Register: `php-ionos/app/product_facts.php` (Version 1.0, geprüft 13.09.2026, 47 Aussagen: 36 technisch getestet,
5 öffentlich behauptet, 2 geplant, 4 ungeklärt; 40 öffentlich). Snapshot: `docs/contracts/product-facts.snapshot.json`.
...
| Tarif | `plans`-Seed, `bin/billing-setup-stripe.php`, `pricing.php`, `billing.php`, `tools/pricing-check.php` Abschnitt D | Preis öffentlich seit 13.09.2026 (Betrag, Steuerhinweis, Periode); Vergleichspreis 50,00 EUR gesperrt (TARIF-07 ungeklärt) |
...
Not-Stopp, 2FA-Pflicht, Mandantentrennung, Protokoll, Tarifname, Preis 25,00 EUR netto je vier Wochen, 28-Tage-Periode, rollierender Stichtag, keine Begrenzung,
Kündigung zum Periodenende, keine Rückschreibung, kein B2B.

Nicht öffentlich: Vergleichspreis, Lexware-Tarif, sevdesk-Freigabedetails, Hosting-Standort, Rechtsdokumente,
