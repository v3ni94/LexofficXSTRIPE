...
- Die Google-Ads-Kennung AW-18431688840 ist für lexware-einzug.de (seit 05.09.2026), smart-einzug.de und die Anwendung app.smart-einzug.de (beide seit 10.09.2026, Vorgabe Betreiber; in der Anwendung nur auf den öffentlichen Seiten register.php und vormerken.php, siehe docs/entwickler/sicherheit.md) hinterlegt (`assets/js/site.js`, Zuordnung je Hostname, Laden erst nach Einwilligung). Googles automatische Tag-Prüfung findet das Tag deshalb nicht; der Nachweis läuft über echte Treffer nach Einwilligung (Entscheidung 10.09.2026: kein erweiterter Consent Mode ohne rechtliche Prüfung). Das Conversion-Label liegt seit dem 12.09.2026 vor: Aktion „Kauf (1)“, `AW-18431688840/3yI5CMyYwfIcEIiB9dRE`. Gemeldet wird der Klick auf Registrieren auf smart-einzug.de. Zu beachten: Damit misst eine als „Kauf“ benannte Aktion eine Absicht, nicht den Abschluss eines Abonnements; für den tatsächlichen Abschluss wäre eine zweite Conversion-Aktion nötig, die die Anwendung auf der Bestätigungsseite der Bestellung melden kann (`analytics.ads_conversion_label`).
