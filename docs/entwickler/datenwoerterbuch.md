...
| stripe_charges_enabled | TINYINT(1) | ja |  | Ergebnis der letzten Kontopruefung (GET /v1/account charges_enabled): 1 Zahlungen freigeschaltet, 0 nicht, NULL unbekannt (Migration 035, 4.76) |
