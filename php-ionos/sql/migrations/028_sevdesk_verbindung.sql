...
-- Hinweis 08.09.2026: api_version ist VARCHAR(20); die erste Fassung dieser Migration schrieb einen laengeren Wert
-- (Lauf #73, 'Data too long'), der Wert wurde auf 'v1' gekuerzt, die Erlaeuterung steht in notes.
...
UPDATE integration_providers
   SET status = 'development',
       ...
       api_version = 'v1',
       notes = 'sevdesk-API v1, Systemversion 2.0 (Annahme). Adapter nach Sekundaerquellen gebaut (07.09.2026), nicht mit Testkonto verifiziert. Lesen ab Freigabe (sevdesk_connect oder sevdesk_release_at); offener Restbetrag und Einzug erst nach Bestaetigung (sevdesk_api_verified, sevdesk_collections). Kein Schreibzugriff.'
