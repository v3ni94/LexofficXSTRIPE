-- 035: Stripe-Verbindungszustand je Firma (Version 4.79, wiederholbar, rein additiv)
--
...
-- NULL bedeutet: mit dem Code vor 4.79 verbunden, noch nicht neu geprueft (kein Einzug wird deshalb gesperrt).
