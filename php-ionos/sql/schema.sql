...
-- Job-Queue, Worker, Synchronisationshistorie, Circuit Breaker (Migration 018). Zeiten UTC außer sync_runs.
...
CREATE TABLE IF NOT EXISTS payment_collections (
    ...
    mandate_id               CHAR(36)     NULL,     -- NULL bei importierten Einzügen (Migration 009)
    customer_iban_id         CHAR(36)     NULL,
...
-- Migration 018: Wartungsmodus je Firma (nur Synchronisation) und Feature-Flags je Firma
ALTER TABLE organizations
...
-- ---------------------------------------------------------------------------
-- Bestehende Einzüge aus Stripe übernehmen (Migration 009, app/stripe_import.php)
-- ---------------------------------------------------------------------------
ALTER TABLE payment_collections
...
-- ---------------------------------------------------------------------------
-- Hilfe-Center: Support-Anfragen (Migration 012, app/support_tickets.php)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Marketingmodul (Migration 034, Version 4.63): Listen, Sperrliste, Kampagnen, Versand, SES-Ereignisse
-- ---------------------------------------------------------------------------
