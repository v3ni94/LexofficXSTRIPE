...
/**
 * Verbindungszustaende zu Stripe (seit 4.76). Kontoverbindung ist ein eigener Zustandsbereich, getrennt von Einzug,
 ...
 * unverified (Verbindung aus der Zeit vor 4.76, noch nicht neu geprueft) und sepa_pending (Stripe prueft noch).
 */
 ...
 *
 * Seit 4.76 werden zusaetzlich charges_enabled und capabilities.sepa_debit_payments uebernommen: Ein Konto ohne
