...
function audit_action_label(string $action): string
{
    static $map = [
        ...
        'mandate_file_uploaded'    => 'Mandatsdokument hochgeladen',
        'mandate_file_viewed'      => 'Mandatsdokument abgerufen',
        'mandate_file_deleted'     => 'Mandatsdokument gelöscht',
        ...
        'collections_bulk_cancelled' => 'Vorgemerkte und terminierte Einzüge gesammelt storniert',
        'collections_due_forced'   => 'Fällige Einzüge außerhalb des Einreichfensters eingereicht (Zweitbestätigung)',
        ...
        'collection_refunded'      => 'Erstattung aus Stripe übernommen',
        'invoice_review_cleared'   => 'Klärung der Rechnung abgeschlossen',
        'alerts_mailed'            => 'Alarm-E-Mail an Inhaber versendet',
        'twofa_reauth_failed'      => 'Zweitbestätigung (2FA-Code) fehlgeschlagen',
        'collections_paused'       => 'Not-Stopp aktiviert (Einzüge angehalten)',
        'collections_resumed'      => 'Not-Stopp aufgehoben (Einzüge freigegeben)',
        'collections_due_skipped_paused' => 'Fällige Einzüge wegen Not-Stopp übersprungen',
        'collection_attempt_recovered' => 'Unklarer Einzugsversuch geklärt (Einzug gefunden)',
        'collection_attempt_cleared'   => 'Unklarer Einzugsversuch geklärt (kein Einzug bei Stripe)',
        'collections_exported'     => 'Einzugsjournal exportiert (CSV)',
        'mandate_request_sent'     => 'Mandat digital angefordert (Link versendet)',
        'mandate_request_reminded' => 'Erinnerung zur digitalen Mandatsanforderung',
        'mandate_request_revoked'  => 'Digitale Mandatsanforderung widerrufen',
        'mandate_request_started'  => 'Kunde hat digitale Mandatsbestätigung begonnen',
        ...
        'migration_failed'         => 'Datenbankmigration fehlgeschlagen (manuelle Klärung)',
